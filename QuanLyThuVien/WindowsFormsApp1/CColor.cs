...
namespace WindowsFormsApp1
{
    class CColor
    {
        ...
        public static Color color8 = Color.FromArgb(73, 78, 83);//Màu button đang ắn
        public static Color color9 = Color.FromArgb(61, 68, 75);//Màu thanh khoảng cách
        public static Color color10 = Color.FromArgb(52, 58, 64);//Màu thanh menu, button ban đầu
        public static Color color11 = Color.FromArgb(82, 88, 93);//Màu đè button
    }
}
